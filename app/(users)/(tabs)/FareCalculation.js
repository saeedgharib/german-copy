...
const CompanyFare = () => {
  ...
  const fetchPublishableKey = async () => {
    const response = await fetch("http://192.168.1.71:3000/pubkey", {
      method: "GET",
      headers: {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      try {
        await fetch("http://192.168.1.71:4000/api/Payment-Notification", {
          method: "POST",
  ...
  const fetchPaymentSheetParams = async () => {
    ...
    try {
      ...
      const response = await fetch("http://192.168.1.71:3000/payment-sheet", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
